...
public class HEVCQsvConfigurationsPanel extends JDialog implements ActionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private VideoHEVCQsvEncodingInfoContainer infocont;
	...
	private JComboBox<ProfileHEVCQsv> comboBoxprofiles;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					VideoHEVCQsvEncodingInfoContainer cont = new VideoHEVCQsvEncodingInfoContainer();

					HEVCQsvConfigurationsPanel dialog = new HEVCQsvConfigurationsPanel(cont);
	...
	public HEVCQsvConfigurationsPanel(VideoHEVCQsvEncodingInfoContainer infocont) {
		initGUI();
	...
	private void initGUI() {
		...
		this.comboBoxprofiles = new JComboBox<ProfileHEVCQsv>();
		...
		chckbxGbp = new JCheckBox("gpb");
		GridBagConstraints gbc_chckbxGbp = new GridBagConstraints();
		gbc_chckbxGbp.anchor = GridBagConstraints.EAST;
		gbc_chckbxGbp.insets = new Insets(0, 0, 5, 5);
		gbc_chckbxGbp.gridx = 0;
		gbc_chckbxGbp.gridy = 12;
		panel.add(chckbxGbp, gbc_chckbxGbp);
	...
	private void initializeComponents() {
		...
		comboBoxprofiles.setModel(new DefaultComboBoxModel<>(ProfileHEVCQsv.values()));
	...
	private void saveChoosenOptionsToContainer() {
		...
		infocont.setProfile((ProfileHEVCQsv) comboBoxprofiles.getSelectedItem());
		infocont.setPixelformat( (PixelFormatQsv) comboBoxpixelformat.getSelectedItem());
	...
	private void setInfoFromEncodingContainer() {
		...
		if (infocont.getExtrainfocont() != null) {
			HEVCQsvExtraInfoContainer extra = (HEVCQsvExtraInfoContainer) infocont.getExtrainfocont();
			...
			chckbxGbp.setSelected(extra.isGpb());
	...
	private void saveExtraOptions() {
		HEVCQsvExtraInfoContainer extrainfo = new HEVCQsvExtraInfoContainer();
		...
		extrainfo.setGpb(chckbxGbp.isSelected());
