...
public class HEVCNvencConfigurationsPanel extends JDialog implements ActionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private VideoHEVCNvencEncodingInfoContainer infocont;
	...
	private JComboBox<ProfilesHEVCNvenc> comboBoxprofiles;
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					HEVCNvencConfigurationsPanel dialog = new HEVCNvencConfigurationsPanel(cont);
	...
	public HEVCNvencConfigurationsPanel(VideoHEVCNvencEncodingInfoContainer infocont) {
		initGUI();
	...
	private void initGUI() {
		...
		this.comboBoxprofiles = new JComboBox<ProfilesHEVCNvenc>();
		...
		this.panel.add(this.spinnerintqpl, gbc_spinnerintqpl);
				...
				gbc_spinnertier.insets = new Insets(0, 0, 5, 0);
				gbc_spinnertier.gridx = 1;
				gbc_spinnertier.gridy = 8;
				panel.add(spinnertier, gbc_spinnertier);
		 ...
		 */
						...
						gbc_chckbxNoscenecut.insets = new Insets(0, 0, 5, 0);
						gbc_chckbxNoscenecut.gridx = 1;
						gbc_chckbxNoscenecut.gridy = 12;
						this.panel.add(this.chckbxNoscenecut, gbc_chckbxNoscenecut);
								...
								gbc_chckbxTemporalaq.insets = new Insets(0, 0, 5, 0);
								gbc_chckbxTemporalaq.gridx = 1;
								gbc_chckbxTemporalaq.gridy = 13;
								this.panel.add(this.chckbxTemporalaq, gbc_chckbxTemporalaq);
										...
										gbc_chckbxNonrefp.insets = new Insets(0, 0, 5, 0);
										gbc_chckbxNonrefp.gridx = 1;
										gbc_chckbxNonrefp.gridy = 14;
	...
	private void initializeComponents() {
		...
		comboBoxprofiles.setModel(new DefaultComboBoxModel<>(ProfilesHEVCNvenc.values()));
	...
	private void initExtendeComponents() {
		...
		spinnerintqpl.setModel(modeltier);
	...
	private void saveChoosenOptionsToContainer() {
		...
		infocont.setProfile((ProfilesHEVCNvenc) comboBoxprofiles.getSelectedItem());
	...
	private void setInfoFromEncodingContainer() {
		...
		if (infocont.getExtrainfocont() != null) {
			HevcNvencExtraInfoContainer extra = (HevcNvencExtraInfoContainer) infocont.getExtrainfocont();
			...
			spinnertier.setValue(extra.getTier());
	...
	private void saveExtraOptions() {
		HevcNvencExtraInfoContainer extrainfo = new HevcNvencExtraInfoContainer();
		...
		extrainfo.setTier((int) spinnertier.getValue());
