...
*/
public class VideoMediaInfoPanel2 extends JTabbedPane {
	...
	/** The j panelaudio. */
	private AudioInfoPanel jPanelaudio;
		...
		try {
			{
				...
				}
				{
					...
					jPanelaudio = new AudioInfoPanel();
	...
	private void addnewvideoinfo(MediaInfoContainer mediavideoinfo){
		...
		AudioStreamInfo audioinfo=mediavideoinfo.getfirstAudioStream();
		 ...
		 if(audioinfo!=null)
			 this.jPanelaudio.addAudioStreams(mediavideoinfo.getAudiostreamsinfo());
