...
public class RencoderLogsPanel extends JDialog implements ActionListener{
	...
	private JCheckBox chckbxShowFfmpegLog;
	...
	private void initGui() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/icons/rencoderbig.png")));
		{
			...
			}
			{
				...
				gbl_panelapplog.columnWeights = new double[]{1.0,1.0,1.0,1.0,0.0,1.0,1.0};
				...
				}
				{
					...
					btnNewButtonorsvclog.addActionListener(this);
					{
						...
						gbc_comboBoxorsvclog.gridwidth = 3;
						gbc_comboBoxorsvclog.insets = new Insets(0, 0, 5, 5);
						gbc_comboBoxorsvclog.fill = GridBagConstraints.HORIZONTAL;
						gbc_comboBoxorsvclog.gridx = 1;
						gbc_comboBoxorsvclog.gridy = 1;
						panelapplog.add(comboBoxorsvclog, gbc_comboBoxorsvclog);
					}
					{
						chckbxShowFfmpegLog = new JCheckBox("Show log of ffmpeg");
						GridBagConstraints gbc_chckbxShowFfmpegLog = new GridBagConstraints();
						gbc_chckbxShowFfmpegLog.gridwidth = 2;
						gbc_chckbxShowFfmpegLog.insets = new Insets(0, 0, 5, 5);
						gbc_chckbxShowFfmpegLog.gridx = 5;
						gbc_chckbxShowFfmpegLog.gridy = 1;
						panelapplog.add(chckbxShowFfmpegLog, gbc_chckbxShowFfmpegLog);
					}
	...
	private void checkFFmpeglogAtRencoderLog() {
		chckbxShowFfmpegLog.setSelected(LogManager.showFFmpegAtRencoderLog());
	}
	...
	private void writeConfigSettings(){
		...
		PropertiesWorker.ChangePropertiesParam(pathconf, StaticGlobalFields.LOGFFMPEGRENCODER, String.valueOf(chckbxShowFfmpegLog.isSelected()));
