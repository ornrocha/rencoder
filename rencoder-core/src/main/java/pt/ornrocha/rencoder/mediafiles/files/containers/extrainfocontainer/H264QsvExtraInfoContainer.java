...
public class H264QsvExtraInfoContainer implements IExtraInfoContainer {
	...
	private H264QsvExtraInfoContainer(int async_depth, int rdo, int max_frame_size, int max_slice_size,
		int bitrate_limit, int mbbrc, int extbrc, int adaptive_i, int adaptive_b, int b_strategy,
		int idr_interval, int max_dec_frame_buffering, int look_ahead, int look_ahead_depth,
		int look_ahead_downsampling, int int_ref_type) {
	    this.async_depth = async_depth;
	    this.rdo = rdo;
	    this.max_frame_size = max_frame_size;
	    this.max_slice_size = max_slice_size;
	...
	public IExtraInfoContainer clone() {
		return new H264QsvExtraInfoContainer(async_depth, rdo, max_frame_size, max_slice_size,
			...
			idr_interval, max_dec_frame_buffering, look_ahead, look_ahead_depth,
			look_ahead_downsampling, int_ref_type);
	}
	...
	public static H264QsvExtraInfoContainer loadH264QsvExtraInfoContainer(PropertiesConfiguration props) {
...
//				|| props.containsKey(StaticVideoEncoderFields.H264NVENCINITQPI)) {
			...
			newextracont.setMax_dec_frame_buffering(PropertiesWorker.checkProperty(props, "max_dec_frame_buffering", 0));
			...
			newextracont.setLook_ahead_downsampling(PropertiesWorker.checkProperty(props, "look_ahead_downsampling", 0));
