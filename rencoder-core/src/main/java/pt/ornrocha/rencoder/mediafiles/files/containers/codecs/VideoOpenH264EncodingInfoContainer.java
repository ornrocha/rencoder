...
public class VideoOpenH264EncodingInfoContainer extends DefaultEncodingInfoContainer {
  ...
  public void setConfigurations(PropertiesConfiguration props) {
    ...
    if (slicemode.equals(Openh264SliceMode.fixed)) {
      setSlicenumber(PropertiesWorker.checkProperty(props,
          StaticVideoEncoderFields.VIDEONUMBERSLICES, 0, 500, 0));
    }
    setLoopfilter(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.OPENH264LOOPFILTER, true));
    setMax_nal_size(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.OPENH264MAXNAL, 0, 1, 0));
    setAllow_skip_frames(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.OPENH264SKIPFRAMES, false));
    setCabac(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.OPENH264CABAC, false));
    setGopsize(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.OPENH264GOPSIZE, 0, 500, 0));
    setMaxrate(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.OPENH264MAXRATE, 0, 50, 0));
  ...
  protected void saveSpecificCodecProperties(PropertiesConfiguration prop) {
    ...
    prop.setProperty(StaticVideoEncoderFields.OPENH264SKIPFRAMES,
        String.valueOf(allow_skip_frames));
