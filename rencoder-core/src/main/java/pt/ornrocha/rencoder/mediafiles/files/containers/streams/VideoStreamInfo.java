...
public class VideoStreamInfo extends StreamInfo {
  ...
  public List<Object[]> getVideoInfoToTable() {
    ...
    Object[] duration =
        {LangTools.getWordLanguage("Duration", "videoaudiogui.duration"), this.videototalduration};
    Object[] aspect =
        {LangTools.getResourceBundleWordLanguage(rb, "Video aspect", "videogui.aspect"),
