...
public class VideoKvazaarEncodingInfoContainer extends DefaultEncodingInfoContainer {
  ...
  public void setConfigurations(PropertiesConfiguration props) {
    ...
    setPeriod(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.KVAZAARPERIOD, 0, 500, 64));
    setTiles(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.KVAZAARTILES, 0, 50, 0));
