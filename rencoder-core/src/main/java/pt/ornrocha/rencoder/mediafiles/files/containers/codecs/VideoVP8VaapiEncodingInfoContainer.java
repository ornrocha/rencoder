...
public class VideoVP8VaapiEncodingInfoContainer extends DefaultEncodingInfoContainer {
  ...
  public void setConfigurations(PropertiesConfiguration props) {
    ...
    setLoop_filter_level(
        PropertiesWorker.checkProperty(props, "vpxvaapi.loop.filter.level", 0, 63, 16));
    setLoop_filter_sharpness(
        PropertiesWorker.checkProperty(props, "vpxvaapi.loop.filter.sharpness", 0, 15, 4));
