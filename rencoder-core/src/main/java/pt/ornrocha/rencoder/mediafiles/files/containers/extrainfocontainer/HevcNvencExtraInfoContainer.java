...
public class HevcNvencExtraInfoContainer implements IExtraInfoContainer {
  ...
  // -rc-lookahead <int> E..V..... Number of frames to look ahead for rate-control (from 0 to
  // INT_MAX) (default 0)
  // -surfaces <int> E..V..... Number of concurrent surfaces (from 0 to 64) (default 0)
  // -cbr <boolean> E..V..... Use cbr encoding mode (default false)
  // -2pass <boolean> E..V..... Use 2pass encoding mode (default auto)
  // -gpu <int> E..V..... Selects which NVENC capable GPU to use. First GPU is 0, second is 1, and
  // so on. (from -2 to INT_MAX) (default any)
  // any E..V..... Pick the first device available
  // list E..V..... List the available devices
  // -delay <int> E..V..... Delay frame output by the given amount of frames (from 0 to INT_MAX)
  // (default INT_MAX)
  // -no-scenecut <boolean> E..V..... When lookahead is enabled, set this to 1 to disable adaptive
  // I-frame insertion at scene cuts (default false)
  // -forced-idr <boolean> E..V..... If forcing keyframes, force them as IDR frames. (default false)
  // -spatial_aq <boolean> E..V..... set to 1 to enable Spatial AQ (default false)
  // -temporal_aq <boolean> E..V..... set to 1 to enable Temporal AQ (default false)
  // -zerolatency <boolean> E..V..... Set 1 to indicate zero latency operation (no reordering delay)
  // (default false)
  // -nonref_p <boolean> E..V..... Set this to 1 to enable automatic insertion of non-reference
  // P-frames (default false)
  // -strict_gop <boolean> E..V..... Set 1 to minimize GOP-to-GOP rate fluctuations (default false)
  // -aq-strength <int> E..V..... When Spatial AQ is enabled, this field is used to specify AQ
  // strength. AQ strength scale is from 1 (low) - 15 (aggressive) (from 1 to 15) (default 8)
  // -cq <float> E..V..... Set target quality level (0 to 51, 0 means automatic) for constant
  // quality mode in VBR rate control (from 0 to 51) (default 0)
  // -aud <boolean> E..V..... Use access unit delimiters (default false)
  // -bluray-compat <boolean> E..V..... Bluray compatibility workarounds (default false)
  // -init_qpP <int> E..V..... Initial QP value for P frame (from -1 to 51) (default -1)
  // -init_qpB <int> E..V..... Initial QP value for B frame (from -1 to 51) (default -1)
  // -init_qpI <int> E..V..... Initial QP value for I frame (from -1 to 51) (default -1)
  // -qp <int> E..V..... Constant quantization parameter rate control method (from -1 to 51)
  // (default -1)
  ...
  private HevcNvencExtraInfoContainer(int tier, int rclookahead, int surfaces, int delay,
      int aqstrength, boolean noscenecut, boolean forcedidr, boolean spatialaq, boolean temporalaq,
  ...
  public IExtraInfoContainer clone() {
    return new HevcNvencExtraInfoContainer(tier, rclookahead, surfaces, delay, aqstrength,
        noscenecut, forcedidr, spatialaq, temporalaq, zerolatency, nonrefp, strictgop, init_qpP,
        init_qpB, init_qpI);
  }
  ...
  public static HevcNvencExtraInfoContainer loadHevcNvencExtraInfoContainer(
    ...
    if (props.containsKey(StaticVideoEncoderFields.H264NVENCRCLOOKEAD)
      ...
      newextracont.setTier(PropertiesWorker.checkProperty(props, "h264nvenc.tier", 0, 1, 0));
