...
public class ProcessFiles {
	 ...
	 * @throws IOException 
	 */
	protected  ArrayList<Videofile> filterallVideofiles(ArrayList<String> listfiles) throws CloneNotSupportedException, IOException{
		ArrayList<Videofile> vidfiles = new ArrayList<>();
		IndexedHashMap<String, FileTypeFilter> allowedvideos = ProcessFilesAux.getAllowedVideoExtension();
