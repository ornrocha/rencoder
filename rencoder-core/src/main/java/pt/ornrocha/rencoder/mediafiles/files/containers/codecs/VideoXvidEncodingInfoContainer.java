...
public class VideoXvidEncodingInfoContainer extends DefaultEncodingInfoContainer {
  ...
  protected ArrayList<VideoContainers> getSupportedFormats() {
    return Arrays.stream(VideoCodecs.XVID.supportsOutputFormats())
  ...
  public void setConfigurations(PropertiesConfiguration props) {
    ...
    setMpeg_quant(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDMPEGQUANT, false));
    setLumi_aq(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDLUMIAQ, false));
    setVariance_aq(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDVARIANCEAQ, false));
    setGmc(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDGMC, false));
    setMe_quality(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDMEQUALITY, 0, 6, 4));
    setFlagsArrayFromSavedString(
        (PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDFLAGS)));
    ...
    setMbd(XvidMBD.getXvidMBDFromString(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDMBD)));
    ...
    setTrellis(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.XVIDTRELLIS, 0, 50, 0));
