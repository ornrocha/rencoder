...
public class ListFiles {
     ...
     */
    public static ArrayList<String> getListofItemsInFolderAndSubFoldersWithFilechooser(Component parent) {
	String folderpath = getFolderpathFileChooser(parent);
	if (folderpath != null)
     ...
     */
    public static ArrayList<String> getItemsTypeInFolderWithFilechooser(ArrayList<FileFilter> filters, Component parent) {
     ...
     */
    public static String getSingleItemTypeInFolderWithFilechooser(IndexedHashMap<String, FileTypeFilter> filters, Component parent) {
	...
	if (!loc.equals("eng")) {
	    ...
	    UIManager.put("FileChooser.newFolderButtonText", rb.getString("filechooser.newFolderButtonText"));
	    UIManager.put("FileChooser.renameFileButtonText", rb.getString("filechooser.renameFileButtonText"));
	    UIManager.put("FileChooser.deleteFileButtonText", rb.getString("filechooser.deleteFileButtonText"));
