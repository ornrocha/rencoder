...
public class VideoH264EncodingInfoContainer extends DefaultEncodingInfoContainer {
  ...
  public IGeneralVideoEncInfoContainer copySpecificInfocontainer(
    ...
    if (this.extrainfocont != null) {
      ((VideoH264EncodingInfoContainer) cont)
          .setExtrainfocont((H264ExtraInfoContainer) extrainfocont.clone());
    }
  ...
  protected ArrayList<VideoContainers> getSupportedFormats() {
    return Arrays.stream(VideoCodecs.H264.supportsOutputFormats())
  ...
  public void setConfigurations(PropertiesConfiguration props) {
    ...
    setPreset(X26xPresets.getX26xPresetsFromString(
    ...
    setFastfirstpass(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.H264FASTFIRSTPASS, false));
    ...
    Integer qp = (Integer) PropertiesWorker.checkProperty(props,
        StaticVideoEncoderFields.VIDEOCONSTQUANT, null);
    if (qp != null)
