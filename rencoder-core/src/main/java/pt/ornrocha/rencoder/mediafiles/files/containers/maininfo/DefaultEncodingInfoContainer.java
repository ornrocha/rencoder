...
public abstract class DefaultEncodingInfoContainer implements IGeneralVideoEncInfoContainer {
  ...
  /** The videocodec. */
  protected VideoCodecs videocodec = VideoCodecs.H264;

  /** The video container. */
  protected VideoContainers videoContainer = VideoContainers.MKV;

  /** The videoaspectsize. */
  protected AspectComponent videoaspectsize = new AspectComponent();

  /** The videoaspectratio. */
  protected AspectRatio videoaspectratio = AspectRatio.SAMEASSOURCE;

  /** The videoframerate. */
  protected FPS videoframerate = FPS.SAMEASSOURCE;
  ...
  protected IndexedHashMap<String, Integer> videoVBRQuality =
      new IndexedHashMap<String, Integer>() {
        /**
         * 
         */
   ...
   * (non-Javadoc)
   * 
   * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer# getVideocodec()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer# isOverwritefile()
   */
  @Override
...
/*
   ...
   * (non-Javadoc)
   * 
   * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer# getOutputFolder()
   */
  // @Override
   ...
   * (non-Javadoc)
   * 
   * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer# getAudiocodec()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer# isUseAudioCBR()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer# isModifiedtag()
   */
  @Override
  ...
  protected void setVideoConfigurations(PropertiesConfiguration props) {
    ...
    if (props.getProperty(StaticVideoEncoderFields.VIDEOASPECTSIZE) != null)
      setVideoaspectsizeComponent(EncodingPropsAuxiliar.getVideoSizeAspect(
          (String) props.getProperty(StaticVideoEncoderFields.VIDEOASPECTSIZE)));
    else
      setVideoaspectsizeComponent(new AspectComponent());
    

    if (props.getProperty(StaticVideoEncoderFields.VIDEOASPECTRATIO) != null)
      setVideoaspectratio(EncodingPropsAuxiliar.getVideoAspectRatio(
          (String) props.getProperty(StaticVideoEncoderFields.VIDEOASPECTRATIO)));
    else
    ...
    boolean usefileSize =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VIDEOUSEFILESIZE, false);
    if (usefileSize) {
      ...
      setUseVideoEncodingFileSize(false);
      setUseVideoEncodingCBR(false);
      setUseVideoEncodingVBR(true);
      ...
      if (putVBR != -1)
        ...
        setVideoVBRQuality(getVideocodec(),
            EncodingPropsAuxiliar.getDefaultVideoCodecQuality(getVideocodec()));
    } else if (PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VIDEOUSECBR, false)) {

      setUseVideoEncodingFileSize(false);
      setUseVideoEncodingCBR(true);
      setUseVideoEncodingVBR(false);

      String videoCBR =
          PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VIDEOCBRVALUE);
    ...
    String hwaccel=PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.HWACCELENGINE);
    if (hwaccel!=null)
    	setHardwareAccelerationDecoder(HWAccel.getHWAccelFromString(hwaccel));

    setFileextension(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VIDEOFILEEXTENSION));

    setTwopassEncoding(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.TWOPASSENCODING, false));

    setOverwritefile(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VIDEOOVERWRITE, false));

    setNumberThreads(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.FFMPEGTHREADS, 1, 32, 1));

  }

  protected void setAudioConfigurations(PropertiesConfiguration props) {

    String descaudiocodec =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOCODEC);
    setAudiocodec(VideoContainers.ValidateandGetAudioCodec(descaudiocodec, getVideoContainer()));

    String ffmpegcmd =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOEXTRAFFMPEGCMD);
    if (ffmpegcmd != null)
      setExtraaudioffmpegcmd(ffmpegcmd);

    setUseonlyextraaudioffmpegcmd(PropertiesWorker.checkProperty(props,
        StaticVideoEncoderFields.AUDIOUSEONLYEXTRAFFMPEGCMD, false));
    ...
    if (!isTwopassEncoding()) {
      ...
      if (PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOUSECBR, false)) {
        ...
        String audioCBR =
            PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOCBRVALUE);
      ...
      } else if (PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOUSEVBR,
          false)) {
        setUseAudioCBR(false);
        String audioVBR =
            PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOVBRVALUE);
        ...
        if (props.containsKey(StaticVideoEncoderFields.AUDIOUSECBR)
          ...
          setUseAudioCBR(false);
          setAudioVariableBitrateValues(
              EncodingPropsAuxiliar.getDefaultAudioCodecQuality(getAudiocodec()));
        }
      }
    } else {
    ...
    String audiochannels =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOPREFCHANNELS);
    ...
    setAc3passthrough(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.AUDIOAC3PASSTHROUGH, false));

  }

  protected void setSubtitleConfigurations(PropertiesConfiguration props) {

    getSubtitleInfoContainer().setUseHardSubs(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSUSEHARDSUBS, false));
    ...
    String fontencoding =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSENCODING);
    if (fontencoding != null)
      getSubtitleInfoContainer()
          .setSubsEncoding(EncodingPropsAuxiliar.getSubEncodingByName(fontencoding));

    String fontalterencoding =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSALTERNATIVEENCODING);
    ...
    int borderstyle =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSBORDERSTYLE, 0, 3, 0);
    if (borderstyle == 1)
    ...
    int suboutline =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSOUTLINE, 0, 20, 1);
    if (suboutline <= 5)
      getSubtitleInfoContainer().setSubsOutline(suboutline);

    int subshadow =
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSSHADOW, 0, 20, 1);
    if (subshadow <= 5)
      getSubtitleInfoContainer().setSubsShadow(subshadow);

    getSubtitleInfoContainer().setSubsUseBold(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSUSEBOLD, false));
    getSubtitleInfoContainer().setSubsUseItalic(
        PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.SUBSUSEITALIC, false));
  ...
  protected void saveVideoProperties(PropertiesConfiguration props, boolean isprofile) {
    ...
    if (!getVideocodec().equals(VideoCodecs.COPY)) {
      ...
      props.setProperty(StaticVideoEncoderFields.VIDEOASPECTRATIO,
          getVideoaspectratio().getVideoRatioID());
      props.setProperty(StaticVideoEncoderFields.VIDEOFRAMERATE,
          getVideoframerate().getVideoFrameRateID());
      ...
      if (getHardwareAccelerationDecoder()!=null && !getHardwareAccelerationDecoder().equals(HWAccel.NONE)) {
      	props.setProperty(StaticVideoEncoderFields.HWACCELENGINE, getHardwareAccelerationDecoder().name());
      }
  ...
  protected void saveVideoEncodingBitratetype(PropertiesConfiguration prop) {
    ...
    if (isUseVideoEncodingCBR()) {
      ...
      prop.setProperty(StaticVideoEncoderFields.VIDEOVBRVALUE,
  ...
  protected void saveAudioProperties(PropertiesConfiguration prop) {
    ...
    if (!isUseonlyextraaudioffmpegcmd()) {
      if (getAudiocodec() != AudioCodecs.COPY) {
        ...
        prop.setProperty(StaticVideoEncoderFields.AUDIOAC3PASSTHROUGH,
            String.valueOf(isAc3passthrough()));
      }
    }
  }
  ...
  protected void saveSubtitlesProperties(PropertiesConfiguration prop) {
    ...
    if (getSubtitleInfoContainer().isUseSoftSubs())
      ...
      prop.setProperty(StaticVideoEncoderFields.SUBSFONT,
          getSubtitleInfoContainer().getSubsFontName());
   ...
   */
  @Override
  public IGeneralVideoEncInfoContainer copyCommoninfoofcontainer(
   ...
   * (non-Javadoc)
   * 
   * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#print ()
   */
  @Override
  public void print() {
