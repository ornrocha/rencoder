...
public class H264NvencExtraInfoContainer implements IExtraInfoContainer {
	...
	private H264NvencExtraInfoContainer(int rclookahead, int surfaces, int delay, int aqstrength, boolean noscenecut,
			boolean forcedidr, boolean badapt, boolean spatialaq, boolean temporalaq, boolean zerolatency,
			boolean nonrefp, boolean strictgop, int init_qpP, int init_qpB, int init_qpI, H264NvencCoder coder) {
		super();
		this.rclookahead = rclookahead;
		this.surfaces = surfaces;
		this.delay = delay;
	...
	public IExtraInfoContainer clone() {
		return new H264NvencExtraInfoContainer(rclookahead, surfaces, delay, aqstrength, noscenecut, forcedidr, badapt,
				spatialaq, temporalaq, zerolatency, nonrefp, strictgop, init_qpP, init_qpB, init_qpI, coder);
	}
	...
	public static H264NvencExtraInfoContainer loadH264NvencExtraInfoContainer(PropertiesConfiguration props) {
		...
		if (props.containsKey(StaticVideoEncoderFields.H264NVENCRCLOOKEAD)
			...
			newextracont
					.setBadapt(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.H264NVENCBADAPT, true));
