 ...
 */
public class VideoVP8EncodingInfoContainer extends DefaultEncodingInfoContainer {// implements IVideoVPxEncInfo{
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoVP8EncInfo#getQualityprofile(
	 * )
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoVP8EncInfo#setQualityprofile(
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoVP8EncInfo#setCpuUsed(int)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoVP8EncInfo#setMinquant(int)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoVP8EncInfo#setMaxquant(int)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoVP8EncInfo#getCputhreads()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoVP8EncInfo#setCputhreads(int)
	 */
	...
	public void setConfigurations(PropertiesConfiguration props) {
		...
		setMinquant(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VP8MINQUANT, -1, 10, -1));
		setMaxquant(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VP8MINQUANT, -1, 42, -1));
