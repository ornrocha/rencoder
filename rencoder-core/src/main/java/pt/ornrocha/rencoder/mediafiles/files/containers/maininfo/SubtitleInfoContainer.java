...
public class SubtitleInfoContainer {
	...
	//Subtitles
		...
		protected SubEncodings subsEncoding=SubEncodings.ISO88591;
		...
		public SubtitleInfoContainer(boolean useHardSubs, boolean useSoftSubs,
				int subsFontSize, String subsFontName, int subsOutline,
				int subsShadow, boolean subsUseBold, boolean subsUseItalic,
				SubtitlesColor subsColor, SubEncodings subsEncoding,
				String subsAlternativeEncoding,
				SubtitlesBorderStyle subsBorderStyle,
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setUseHardSubs(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setUseSoftSubs(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsFontSize(int)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsFontName(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsOutline(int)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsUseBold(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsUseItalic(boolean)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsColor(ffmpegWrapper.enumerators.SubtitlesColor)
		 */
		 ...
		 */
		public SubEncodings getSubsEncoding() {
			return subsEncoding;
		}

		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsEncoding(ffmpegWrapper.enumerators.SubEncodings)
		 */
		public void setSubsEncoding(SubEncodings subsEncoding) {
			this.subsEncoding = subsEncoding;
		}

		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#getSubsAlternativeEncoding()
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsAlternativeEncoding(java.lang.String)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#getSubsBorderStyle()
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsBorderStyle(ffmpegWrapper.enumerators.SubtitlesBorderStyle)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setSubsAlignment(ffmpegWrapper.enumerators.SubtiltesAlignment)
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#isUseMp4SubtitleEncCodec()
		 */
		...
		/* (non-Javadoc)
		 * @see filetreatment.files.containers.interfaces.IGeneralVideoEncInfoContainer#setUseMp4SubtitleEncCodec(boolean)
		 */
		...
		public SubtitleInfoContainer copyInfoContainer(){
			...
			return new SubtitleInfoContainer(useHardSubs, 
					useSoftSubs, 
					subsFontSize, 
					subsFontName, 
					subsOutline, 
					subsShadow, 
					this.isSubsUseBold(), 
					this.isSubsUseItalic(), 
					subsColor, 
					subsEncoding,
					subsAlternativeEncoding, 
					subsBorderStyle, 
					subsAlignment, 
