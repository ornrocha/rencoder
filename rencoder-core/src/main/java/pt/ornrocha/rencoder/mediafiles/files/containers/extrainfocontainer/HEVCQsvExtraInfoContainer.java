...
public class HEVCQsvExtraInfoContainer implements IExtraInfoContainer {
  ...
  private HEVCQsvExtraInfoContainer(int async_depth, int rdo, int max_frame_size,
      int max_slice_size, int bitrate_limit, int mbbrc, int extbrc, int adaptive_i, int adaptive_b,
      int b_strategy, int idr_interval, boolean gpb) {
    super();
    this.async_depth = async_depth;
    this.rdo = rdo;
    this.max_frame_size = max_frame_size;
  ...
  public IExtraInfoContainer clone() {
    return new HEVCQsvExtraInfoContainer(async_depth, rdo, max_frame_size, max_slice_size,
        bitrate_limit, mbbrc, extbrc, adaptive_i, adaptive_b, b_strategy, idr_interval, gpb);
  }
  ...
  public static HEVCQsvExtraInfoContainer loadHEVCQsvExtraInfoContainer(
