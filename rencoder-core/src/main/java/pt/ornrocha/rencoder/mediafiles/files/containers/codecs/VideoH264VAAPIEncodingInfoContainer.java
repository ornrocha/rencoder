...
public class VideoH264VAAPIEncodingInfoContainer extends DefaultEncodingInfoContainer {
	...
	public void setConfigurations(PropertiesConfiguration props) {
		...
		Integer qual = PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.VAAPIQUALITY, null);
		if (qual != null)
			setQuality(qual);
		
		setCoder(H264VaapiCoder.getCoderFromString(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.H264VAAPICODER)));
