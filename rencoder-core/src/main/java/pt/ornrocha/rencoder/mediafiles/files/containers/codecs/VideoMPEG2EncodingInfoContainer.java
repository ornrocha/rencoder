...
public class VideoMPEG2EncodingInfoContainer extends DefaultEncodingInfoContainer {
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#getBframes()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setBframes(int)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#getTrellis()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setTrellis(int)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setPelme(int)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#getPixelformat()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setPixelformat(
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#getGopsize()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setGopsize(int)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#isUsegopsize()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setUsegopsize(
	 * boolean)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#isUsebFrames()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setUsebFrames(
	 * boolean)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#isUseTrellis()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setUseTrellis(
	 * boolean)
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#isUsePelMe()
	 */
	 ...
	 * 
	 * @see
	 * filetreatment.files.containers.interfaces.IVideoMPEG2EncInfo#setUsePelMe(
	 * boolean)
	 */
	...
	public void setConfigurations(PropertiesConfiguration props) {
		...
		Integer gp = (Integer) PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.MPG2GOPSIZE,
				null);
		if (gp != null) {
			if (gp != -1) {
				setUsegopsize(true);
		...
		setUsebFrames(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.MPEG2BFRAME, true));
		setUseTrellis(PropertiesWorker.checkProperty(props, StaticVideoEncoderFields.MPEG2TRELLIS, true));
