...
public enum VideoLevel {
  ...
  public static VideoLevel[] getKvazaarLevels() {
    return getAllowedLevels("none", "1", "2", "2.1", "3", "3.1", "4", "4.1", "5", "5.1", "5.2", "6",
        "6.1", "6.2");
  }

  public static VideoLevel[] getH264VaapiLevels() {
    return getAllowedLevels("none", "1", "1.1", "1.2", "1.3", "2", "2.1", "2.2", "3", "3.1", "3.2",
        "4", "4.1", "4.2", "5", "5.1", "5.2", "6", "6.1", "6.2");
  }


  public static VideoLevel[] getH264NvencLevels() {
    return getAllowedLevels("none", "1", "1.0", "1b", "1.0b", "1.1", "1.2", "1.3", "2", "2.0",
        "2.1", "2.2", "3", "3.0", "3.1", "3.2", "4", "4.0", "4.1", "4.2", "5", "5.0", "5.1");
  }
