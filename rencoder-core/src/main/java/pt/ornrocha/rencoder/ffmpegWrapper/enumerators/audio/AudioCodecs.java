...
public enum AudioCodecs {
  ...
  LCAAC {
    ...
    @Override
    public String getFFmpegID() {
      return FFmpegManager.getInstance().isCodecSupported(this.toString(),
          StaticFFmpegFields.FDKAAC, false) ? StaticFFmpegFields.FDKAAC : StaticFFmpegFields.AAC;
    }
  ...
  HEAAC {
    ...
    public boolean isCodecSupported() {
      return FFmpegManager.getInstance().isCodecSupported(this.toString(),
          StaticFFmpegFields.FDKAAC, false);
    }
  ...
  VORBIS {
    ...
    public boolean isCodecSupported() {
      return FFmpegManager.getInstance().isCodecSupported(this.toString(),
          StaticFFmpegFields.VORBIS, false);
    }
  ...
  OPUS {
    ...
    @Override
    public boolean isCodecSupported() {
      return FFmpegManager.getInstance().isCodecSupported(this.toString(), StaticFFmpegFields.OPUS,
          false);
    }
  ...
  MP2 {
    ...
    public String getFFmpegID() {
      return FFmpegManager.getInstance().isCodecSupported(this.toString(),
          StaticFFmpegFields.LAMEMP2, false) ? StaticFFmpegFields.LAMEMP2 : StaticFFmpegFields.MP2;
    }
