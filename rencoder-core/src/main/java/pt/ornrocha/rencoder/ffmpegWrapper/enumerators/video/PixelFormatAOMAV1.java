 ...
 */
public enum PixelFormatAOMAV1 {

  yuv420p, yuv422p, yuv444p, yuv420p10le, yuv422p10le, yuv444p10le, yuv420p12le, yuv422p12le, yuv444p12le;

  public static PixelFormatAOMAV1 getPixelFormatFromString(String pixelformat) {
    if (pixelformat != null) {
      for (PixelFormatAOMAV1 pformat : PixelFormatAOMAV1.values()) {
        if (pformat.toString().toLowerCase().equals(pixelformat.toLowerCase()))
          return pformat;
      }
    }
    return PixelFormatAOMAV1.yuv420p;
  }
