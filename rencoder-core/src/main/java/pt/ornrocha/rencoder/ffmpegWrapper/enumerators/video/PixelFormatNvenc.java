 ...
 */
public enum PixelFormatNvenc {

    yuv420p, nv12, p010le, yuv444p, p016le, yuv444p16le, bgr0, rgb0, cuda;

    public static PixelFormatNvenc getPixelFormatNvencFromString(String pixelformat) {
	if (pixelformat != null) {
	    for (PixelFormatNvenc pformat : PixelFormatNvenc.values()) {
		if (pformat.toString().toLowerCase().equals(pixelformat.toLowerCase()))
		    return pformat;
	    }
	}
	return PixelFormatNvenc.yuv420p;
    }
