...
public enum VideoContainers {
  ...
  MKV {
    ...
    public ArrayList<AudioCodecs> getAudioFormatsSupported() {
      return (ArrayList<AudioCodecs>) Stream
          .of(AudioCodecs.LCAAC, AudioCodecs.HEAAC, AudioCodecs.MP3, AudioCodecs.VORBIS,
              AudioCodecs.OPUS, AudioCodecs.MP2, AudioCodecs.AC3, AudioCodecs.EAC3)
          .collect(Collectors.toList());
    }
  ...
  MP4 {
    ...
    public ArrayList<AudioCodecs> getAudioFormatsSupported() {
      return (ArrayList<AudioCodecs>) Stream.of(AudioCodecs.LCAAC, AudioCodecs.HEAAC,
          AudioCodecs.MP3, AudioCodecs.MP2, AudioCodecs.AC3).collect(Collectors.toList());
    }
  ...
  FLV {
    ...
    public ArrayList<AudioCodecs> getAudioFormatsSupported() {
      return (ArrayList<AudioCodecs>) Stream
          .of(AudioCodecs.LCAAC, AudioCodecs.HEAAC, AudioCodecs.MP3).collect(Collectors.toList());
    }
  ...
  MPEG {
    ...
    @Override
    public ArrayList<AudioCodecs> getAudioFormatsSupported() {
      return (ArrayList<AudioCodecs>) Stream.of(AudioCodecs.MP3, AudioCodecs.MP2)
          .collect(Collectors.toList());
    }
  ...
  VOB {
    ...
    @Override
    public ArrayList<AudioCodecs> getAudioFormatsSupported() {
      return (ArrayList<AudioCodecs>) Stream.of(AudioCodecs.MP2, AudioCodecs.AC3)
          .collect(Collectors.toList());
    }
  ...
  public static AudioCodecs ValidateandGetAudioCodec(String audiocodecname,
