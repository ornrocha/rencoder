...
public class FFmpegInfoPatterns {
   ...
   */
  public synchronized static IndexedHashMap<String, String> getExistingEncoderTypeInfo(
      EncoderType encodertype, Scanner sc) {
    ...
    Logger.debug("\n####### FFmpeg " + encodertype.toString() + " encoders ########\n");
