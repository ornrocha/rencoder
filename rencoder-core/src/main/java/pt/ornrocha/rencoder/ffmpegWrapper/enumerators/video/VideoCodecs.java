...
public enum VideoCodecs {
	...
	H264 {
		...
		@Override
		public VideoContainers[] supportsOutputFormats() {
			VideoContainers[] res = { VideoContainers.MKV, VideoContainers.MP4, VideoContainers.TS, VideoContainers.FLV,
					VideoContainers.E3GP };
			return res;
		}
	...
	H264VAAPI {
		...
		@Override
		public ArrayList<String> getMainCodecCmd() {
			return (ArrayList<String>) Stream.of(StaticFFmpegFields.encodevideocodec, StaticFFmpegFields.H264vaapi)
					.collect(Collectors.toList());
		...
		@Override
		public ArrayList<String> getDecodingHWAcceleration() {
			return (ArrayList<String>) Stream.of(StaticFFmpegFields.DECODERHWACCEL, StaticFFmpegFields.VAAPI,
					StaticFFmpegFields.VAAPIDEVICEFLAG, StaticFFmpegFields.VAAPIDEVICELINUX,
					StaticFFmpegFields.DECODERHWACCELOUTFORMAT, StaticFFmpegFields.VAAPI).collect(Collectors.toList());
		}
	...
	H264QSV {
		...
		@Override
		public ArrayList<String> getMainCodecCmd() {
			return (ArrayList<String>) Stream.of(StaticFFmpegFields.encodevideocodec, StaticFFmpegFields.H264qsv)
					.collect(Collectors.toList());
...
//					.collect(Collectors.toList());
		...
		@Override
		public ArrayList<String> getDecodingHWAcceleration() {
			return (ArrayList<String>) Stream.of(StaticFFmpegFields.DECODERHWACCEL, "qsv").collect(Collectors.toList());
		}
	...
	HEVCVAAPI {
		...
		@Override
		public ArrayList<String> getMainCodecCmd() {
			return (ArrayList<String>) Stream.of(StaticFFmpegFields.encodevideocodec, StaticFFmpegFields.HEVCvaapi)
					.collect(Collectors.toList());
		...
		public ArrayList<String> getDecodingHWAcceleration() {
			return (ArrayList<String>) Stream
					.of(StaticFFmpegFields.VAAPIDEVICEFLAG,
	...
	HEVCQSV {
		...
		@Override
		public ArrayList<String> getMainCodecCmd() {
			return (ArrayList<String>) Stream.of(StaticFFmpegFields.encodevideocodec, StaticFFmpegFields.HEVCqsv)
					.collect(Collectors.toList());
	...
	public static void main(String[] args) {
		System.out.println(VideoCodecs.H264VAAPI.getCmdDecodingFilter());
	}
