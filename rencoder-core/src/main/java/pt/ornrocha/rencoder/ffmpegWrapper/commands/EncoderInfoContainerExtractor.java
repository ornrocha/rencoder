...
public class EncoderInfoContainerExtractor {
	...
	public static ArrayList<String> getVideoInfoCmds(IGeneralVideoEncInfoContainer encodinfo,
			boolean isusedSoftSubtitles, boolean isusedTwoPassEncoding, boolean firstpassconfigurationstep) {
		...
		if (!(encodinfo instanceof VideoCopyEncodingInfoContainer)) {
			...
			if (encodinfo instanceof VideoXvidEncodingInfoContainer
				...
				videocmds.addAll(encodinfo.getVideocodec().getMainCodecCmd());
				videocmds.addAll(processMpeg2EncoderParameters((VideoMPEG2EncodingInfoContainer) encodinfo));
	...
	private static ArrayList<String> processX264EncoderParameters(VideoH264EncodingInfoContainer encodinfo,
			boolean isusedTwoPassEncoding, boolean firstpassconfigurationstep) {
	...
	private static ArrayList<String> processX265EncoderParameters(VideoH265EncodingInfoContainer encodinfo) {
	 ...
	 */
	private static ArrayList<String> processVPxEncoderParameters(VideoVP8EncodingInfoContainer encodinfo) {
	 ...
	 * @return the array list
	 */
	private static ArrayList<String> processMpeg2EncoderParameters(VideoMPEG2EncodingInfoContainer encodinfo) {
	...
	// Diferente
	private static ArrayList<String> processVideoBitrateValues(IGeneralVideoEncInfoContainer encoinfo) {
		...
		if (encoinfo.isUseVideoEncodingCBR()) {
			...
			if (codec.equals(VideoCodecs.XVID) || codec.equals(VideoCodecs.MPEG4)) {
				...
				String inputcmd = StaticFFmpegFields.x265CRF + String.valueOf(encoinfo.getVideoVBRQualityValue());
	...
	private static ArrayList<String> processVideoAspectRelatedParameters(IGeneralVideoEncInfoContainer encodinfo) {
